...
/* ----------- GET ----------- */
export class BoardGetByIdDto extends IntersectionType(IdStringDto_c) implements IGetByIdReq {}
...
/* ----------- DELETE ----------- */
export class BoardDeleteDto extends IntersectionType(IdStringDto_c) implements IDeleteReq {}
